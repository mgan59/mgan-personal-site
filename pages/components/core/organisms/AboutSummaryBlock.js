...
const AboutSummaryBlock = (props) => {
  return (
    <Frame>
      ...
      <BodyCopy>I've been a startup founder, CTO, interim CEO, and Lead Engineer.  With 20 years of engineering expereince working with earl-stage startups to global enterprise techn companies, and I still spend a significant amount of my time writing code and developing software.</BodyCopy>
